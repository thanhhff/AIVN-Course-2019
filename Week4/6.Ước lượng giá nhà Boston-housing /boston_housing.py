...
n = 14  # size of indivudal (chromosome) - 13 feature + 1 bias
...
features = dataframe.values[:, 1:14]
prices = dataframe.values[:, 14]
...
def create_new_population(old_population, elitism=2, gen=1):
    ...
    if gen % 1 == 0:
        ...
        print(gen, '- Best loss:', compute_loss(sorted_population[m - 1]))
